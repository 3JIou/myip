		...
		if err = json.Unmarshal(body, &ipInfo); err == nil {
			tab.Header = &simpletable.Header{
				Cells: []*simpletable.Cell{
					...
					{Align: simpletable.AlignCenter, Text: "CountryCode"},
					{Align: simpletable.AlignCenter, Text: "Region"},
					{Align: simpletable.AlignCenter, Text: "City"},
					{Align: simpletable.AlignCenter, Text: "Lat"},
					{Align: simpletable.AlignCenter, Text: "Lon"},
					{Align: simpletable.AlignCenter, Text: "Timezone"},
			...
			r := []*simpletable.Cell{
				...
				{Align: simpletable.AlignLeft, Text: fmt.Sprintf("%f", ipInfo.Lat)},
				{Align: simpletable.AlignLeft, Text: fmt.Sprintf("%f", ipInfo.Lon)},
				{Align: simpletable.AlignLeft, Text: fmt.Sprintf("%s", ipInfo.Timezone)},
